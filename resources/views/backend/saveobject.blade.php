...
<form novalidate method="POST" enctype="multipart/form-data" class="form-horizontal" action="{{ route('saveObject',['id'=>$object->id ?? null])  }}">
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                <input name="name" value="{{ $object->name ?? old('name') }}" required type="text" class="form-control" id="name" placeholder="">
            </div>
        </div>
        <div class="form-group">
            <label for="street" class="col-lg-2 control-label">Street *</label>
            <div class="col-lg-10">
                <input name="street" value="{{ $object->address->street ?? old('street')  }}" required type="text" class="form-control" id="street" placeholder="">
            </div>
        </div>
        <div class="form-group">
            <label for="number" class="col-lg-2 control-label">Number *</label>
            <div class="col-lg-10">
                <input name="number" value="{{ $object->address->number ?? old('number')  }}" required type="number" class="form-control" id="number" placeholder="">
            </div>
        </div>
        <div class="form-group">

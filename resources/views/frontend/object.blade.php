...
<div class="container-fluid places">
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <p>{{ substr($room->description,0,70) }}  </p>
    ...
    <div class="collapse" id="collapseExample">
        <div class="well">
            ...
            <form method="POST" action="{{ route('addComment',['commentable_id'=>$object->id, 'commentable_type'=>'App\Models\TouristObject']) }}" class="form-horizontal">
                {{ csrf_field() }} 
                <fieldset>
    ...
    <section>
        ...
        @foreach($object->articles as $article) 
            <div class="articles-list">
                ...
                <p>{{ substr($article->content,0,250) }}  </p> <a href="{{ route('article',['id'=>$article->id]) }}">More</a>
            </div>
    ...
    @auth
        ...
        @if( $object->isLiked() )
            <a href="{{ route('unlike',['likeable_id'=>$object->id,'likeable_type'=>'App\Models\TouristObject']) }}" class="btn btn-primary btn-xs top-buffer">Unlike this object</a>
        @else
            <a href="{{ route('like',['likeable_id'=>$object->id,'likeable_type'=>'App\Models\TouristObject']) }}" class="btn btn-primary btn-xs top-buffer">Like this object</a>
        @endif 

...
<div class="container">
    ...
    @auth
        ...
        @if( $article->isLiked() )
       <a href="{{ route('unlike',['likeable_id'=>$article->id,'likeable_type'=>'App\Models\Article']) }}" class="btn btn-primary btn-xs top-buffer">Unlike this article</a>
        @else
       <a href="{{ route('like',['likeable_id'=>$article->id,'likeable_type'=>'App\Models\Article']) }}" class="btn btn-primary btn-xs top-buffer">Like this article</a>
        @endif 
    ...
    <div class="collapse" id="collapseExample2">
        <div class="well">
            ...
            <form method="POST" action="{{ route('addComment',['commentable_id'=>$article->id, 'commentable_type'=>'App\Models\Article']) }}" class="form-horizontal">
                <fieldset>
